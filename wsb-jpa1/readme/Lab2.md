...
1. Korzystajac z przykladowego kodu dla encji AddressEntity utworz warstwy dostepu do danych (Repository, Service, mappery, TOsy, opcjonalnie RESTy - dla chetnych) dla encji com.jpacourse.persistance.entity.PatientEntity. Spelnione maja byc nasteoujace wymagania:
   ...
   - rozszerz encje com.jpacourse.persistance.entity.PatientEntity o jedno dowolne pole innego typu niz String, odwzoruj je w TO.
