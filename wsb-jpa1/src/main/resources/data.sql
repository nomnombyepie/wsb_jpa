...
INSERT INTO address (doctor_id, patient_id, address_line1, address_line2, city, postal_code) VALUES
                                                                                                 (1, NULL, 'ul. Klonowa 22', 'lok. 5', 'Warszawa', '01-234'),
                                                                                                 (2, NULL, 'ul. Lipowa 11', NULL, 'Kraków', '31-567'),
                                                                                                 (NULL, 3, 'ul. Dębowa 15', 'm. 3B', 'Gdańsk', '81-890'),
                                                                                                 (4, NULL, 'ul. Brzozowa 19', NULL, 'Poznań', '61-901'),
                                                                                                 (NULL, 5, 'ul. Świerkowa 9', 'm. 2', 'Łódź', '91-432'),
                                                                                                 (6, NULL, 'ul. Sosnowa 13', NULL, 'Wrocław', '50-678'),
                                                                                                 (NULL, 7, 'ul. Jesionowa 21', 'lok. 1A', 'Katowice', '40-789'),
                                                                                                 (8, NULL, 'ul. Topolowa 8', NULL, 'Lublin', '20-345'),
                                                                                                 (NULL, 9, 'ul. Wiśniowa 10', 'm. 4', 'Szczecin', '70-890'),
                                                                                                 (NULL, 10, 'ul. Bukowa 17', NULL, 'Bydgoszcz', '85-123');
